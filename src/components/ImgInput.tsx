    ...
    <div>
      ...
      <div className="max-md:w-[90vw]  p-2 w-[364px] h-[220px] mt-[17px] bg-[#a5b8fc3d] rounded border-[2px] border-dotted border-[#A5B8FC] flex flex-col gap-3 justify-center relative">
        ...
        <span className="flex flex-col gap-3">
          <p className="text-sm">Arraste 5 imagens para aqui ou podes abrir as imagens pelo navegação do dispositivo</p>
        ...
        <input type="file" name="image[]" multiple className="left-0 p-2 w-[364px] h-[220px] absolute opacity-0"/>
      </div>
    </div>
  )
}
